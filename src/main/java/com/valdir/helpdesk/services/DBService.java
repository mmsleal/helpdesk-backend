...
public class DBService {
	...
	public void instanciaDB() {
		Tecnico tec1 = new Tecnico(null, "Valdir Cezar", "06605469577", "valdir@mail.com", encoder.encode("123"));
		tec1.addPerfil(Perfil.ADMIN);

		Cliente cli1 = new Cliente(null, "Linus Torvals", "95750048926", "torvals@mail.com", encoder.encode("123"));
